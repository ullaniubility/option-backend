...
import static com.ulla.rocketmq.utils.MessageConverter.convertObjectToByteArray;
...
public class RocketTemplate implements InitializingBean {
    ...
    public SendResult convertAndSend(Object msg, String topic, String tags, long timeout, MessageQueueSelector selector,
        int order) {
        return convertAndSend(msg, topic, tags, "", timeout, selector, order);
    }

    public SendResult convertAndSend(Object msg, String topic, String tags, String keys, MessageQueueSelector selector,
        int order) {
        return convertAndSend(msg, topic, tags, keys, sendMsgTimeout, selector, order);
    }

    public SendResult convertAndSend(Object msg, String topic, String tags, String keys, long timeout,
        MessageQueueSelector selector, int order) {
    ...
    public void convertAndSend(Object msg, String topic, String tags, String keys, long timeout,
