...
@Data
public class QuotationMo extends BaseIdEntity implements Serializable, Cloneable {
    private static final long serialVersionUID = 1L;
    private static QuotationMo quotationProductMo = new QuotationMo();
     ...
     * @return
     */
    public static QuotationMo getInstance() {
        try {
            return (QuotationMo)quotationProductMo.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
        }
        return new QuotationMo();
    }
