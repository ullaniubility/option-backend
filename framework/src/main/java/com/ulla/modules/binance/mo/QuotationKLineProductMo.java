 ...
 */
@Data
@TableName("ba_quotation_kline")
public class QuotationKLineProductMo extends BaseIdEntity implements Serializable, Cloneable {
    private static final long serialVersionUID = 1L;
    private static QuotationKLineProductMo quotationProductMo = new QuotationKLineProductMo();
    ...
    public QuotationKLineProductMo() {
        super();
    }
     ...
     * @return
     */
    public static QuotationKLineProductMo getInstance() {
        try {
            return (QuotationKLineProductMo)quotationProductMo.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
        }
        return new QuotationKLineProductMo();
    }
