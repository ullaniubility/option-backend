...
import com.ulla.modules.binance.qo.WebsocketMessageBase;
 ...
 */
@Data
public class WebsocketTransactionCategoryQo extends WebsocketMessageBase {

    /**
     * 查询类型 1 一级大类 2 二级类
     */
    @ApiModelProperty("查询类型 1 一级大类 2 二级类")
