...
@TableName("sys_deposit_config_history")
@ApiModel(value = "SysDepositConfig对象", description = "入金配置表")
public class DepositConfigHistoryMo extends BaseEntity {


    @ApiModelProperty("主表入金配置id")
