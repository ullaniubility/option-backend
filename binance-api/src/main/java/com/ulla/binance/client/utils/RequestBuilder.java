...
public final class RequestBuilder {
        ...
        try {
            ...
            switch (httpMethod) {
                case POST:
                    ...
                    break;
                case GET:
                    request = new Request.Builder().url(fullUrl).get()
                        .addHeader("Content-Type", "application/x-www-form-urlencoded").build();
                    break;
                case PUT:
                    request = new Request.Builder().url(fullUrl).put(RequestBody.create("", JSON_TYPE))
                        .addHeader("Content-Type", "application/x-www-form-urlencoded").build();
                    break;
                case DELETE:
                    request = new Request.Builder().url(fullUrl).delete()
                        .addHeader("Content-Type", "application/x-www-form-urlencoded").build();
                    break;
                default:
    ...
    public static Request buildApiKeyRequest(String fullUrl, HttpMethod httpMethod, String apiKey) {
        try {
            ...
            switch (httpMethod) {
                case POST:
                    request = new Request.Builder().url(fullUrl).post(RequestBody.create("", JSON_TYPE))
