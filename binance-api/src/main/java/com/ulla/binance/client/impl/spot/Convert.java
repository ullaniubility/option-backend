package com.ulla.binance.client.impl.spot;

import java.util.LinkedHashMap;

import com.ulla.binance.client.enums.HttpMethod;
import com.ulla.binance.client.utils.*;

/**
 * <h2>Convert Endpoints</h2> All endpoints under the
 * <a href="https://binance-docs.github.io/apidocs/spot/en/#convert-endpoints">Convert Endpoint</a> section of the API
...
public class Convert {
    ...
    public Convert(String baseUrl, String apiKey, SignatureGenerator signatureGenerator, boolean showLimitUsage,
        ProxyAuth proxy) {
        this.baseUrl = baseUrl;
     ...
     * 
     * @param parameters
     *            LinkedHashedMap of String,Object pair where String is the name of the parameter and Object is the
