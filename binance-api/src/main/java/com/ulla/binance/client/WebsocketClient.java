package com.ulla.binance.client;

import java.util.ArrayList;

import com.ulla.binance.client.utils.WebSocketCallback;
...
public interface WebsocketClient {
    ...
    int klineStream(String symbol, String interval, WebSocketCallback onOpenCallback,
    ...
    int rollingWindowTicker(String symbol, String windowSize, WebSocketCallback onOpenCallback,
        WebSocketCallback onMessageCallback, WebSocketCallback onClosingCallback, WebSocketCallback onFailureCallback);

    int allRollingWindowTicker(String windowSize, WebSocketCallback callback);

    int allRollingWindowTicker(String windowSize, WebSocketCallback onOpenCallback, WebSocketCallback onMessageCallback,
        WebSocketCallback onClosingCallback, WebSocketCallback onFailureCallback);
