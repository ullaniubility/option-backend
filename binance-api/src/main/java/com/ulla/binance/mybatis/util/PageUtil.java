package com.ulla.binance.mybatis.util;
...
import com.ulla.binance.common.utils.BeanUtil;
import com.ulla.binance.common.utils.StringUtils;
import com.ulla.binance.common.vo.PageVo;
import com.ulla.binance.common.vo.SearchVo;
...
public class PageUtil {
    ...
    /**
     * 生成条件搜索 全对象对比 equals 如果需要like 需要另行处理
     *
     * @param object
     *            对象（根据对象构建查询条件）
     * @return 查询wrapper
    ...
    public static <T> QueryWrapper<T> initWrapper(Object object, SearchVo searchVo) {
        ...
        // 创建时间区间判定
        if (searchVo != null && StrUtil.isNotBlank(searchVo.getStartDate())
